...
export function OnboardingWizard() {
  ...
  useEffect(() => {
    ...
    // Skip during prerender / headless crawlers — otherwise the open dialog
    // gets serialized into the static HTML and makes the whole page inert.
    if (typeof navigator !== "undefined" && navigator.webdriver) return;
    if (!localStorage.getItem(STORAGE_KEY)) {
      // Defer one tick so SSR hydration completes before opening.
