...
import { members as seedMembers, type Member, plans } from "@/lib/mock-data";
import { Download, Edit, Eye, Plus, Search, Trash2, Upload, Users } from "lucide-react";
...
function MembersPage() {
  ...
  const filtered = useMemo(() => list.filter((m) => {
    ...
    return true;
  }), [list, q, planFilter, statusFilter]);
